            ...
            <div class="container">
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control" id="title"
                        placeholder="Masukkan Judul" value="{{ $anime->title }}">
                    @error('title')
                        <div>{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="genre" class="form-control" id="genre"
                        placeholder="Masukkan Genre" value="{{ $anime->genre }}">
                    @error('genre')
                        <div>{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="release_year" class="form-control" id="release_year"
                        placeholder="Masukkan Tahun Terbit" value="{{ $anime->release_year }}">
                    @error('release_year')
                        <div>{{ $message }}</div>
                    @enderror
                </div>
